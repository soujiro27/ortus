...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'El archivo subido excede el maximo permitido',
        2 => 'El archivo subido excede el maximo permitido',
        ...
        8 => 'La extensión de PHP se detuvo la carga de archivos',
        'post_max_size' => 'El archivo subido excede el maximo permitido',
        'max_file_size' => 'El archivo es demasiado grande',
        'min_file_size' => 'El archivo es demasiado pequeño',
        'accept_file_types' => 'Extensión no autorizada',
        'max_number_of_files' => 'Número máximo de archivos superado',
        'max_width' => 'La imagen excede anchura máxima',
        'min_width' => 'La imagen requiere un ancho mínimo',
        'max_height' => ' La imagen excede la altura máximo',
    ...
    protected function initialize() {
        switch ($this->get_server_var('REQUEST_METHOD')) {
            ...
            case 'DELETE':
                ...
                break;
            default:
                $this->header('Método no permitido');
        }
    }
